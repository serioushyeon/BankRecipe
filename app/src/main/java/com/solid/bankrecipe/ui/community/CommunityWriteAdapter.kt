...
class CommunityWriteAdapter(val itemList: ArrayList<Uri>, val context: Context) :
    RecyclerView.Adapter<CommunityWriteAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CommunityWriteAdapter.ViewHolder, position: Int) {

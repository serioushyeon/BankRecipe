 ...
 * Use the [MyCommunityFinishFragment.newInstance] factory method to
...
class MyCommunityFinishFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MyCommunityFinishFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MyCommunityFinishFragment().apply {
